...
class RA_ELITE_USA_INSURANCE_SHORTCODES
{
	...
	function application_form() {
        ...
        if (!is_user_logged_in()) {
            ...
            if ($current_user['roles'][0] == 'elite_usa_insurance_agent' && empty($current_user['agreement_form'])) {
                ...
                echo RA_ELITE_USA_INSURANCE_TEMPLATE::render_view(['main'],['countries.min', 'setup-v1.0.1.min', 'applications/main-v1.10.2'],'forms/quote_application');
            }
        }
	}
	...
	public function ra_elite_usa_insurance_enqueue_ss() {
        ...
        if (is_user_logged_in())  {
            ...
            wp_enqueue_script('elite-usa-notifications', $assets . "/js/notifications/{$file}-v1.0.0.js", array('vue-js'));
        }
