                  ...
                  <table border='0' cellpadding='0' cellspacing='0' style='border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;'>
                    <tr>
                      <td style='font-size: 16px; vertical-align: top;'>
                        <p>Your login credentials to access the dashboard have been updated.</p>

                        <p>Please see below for details of the new login credentials:</p>

                        <p>Email: <?php echo $email ?></p>

                        <p>Password: <?php echo $password ?></p>
                        <p style="text-align: center;"> 
                          <a href="<?php echo site_url() ?>" target='_blank' style='display: inline-block; color: #ffffff; background-color: #1231ef; border: solid 1px #1231ef; border-radius: 5px; box-sizing: border-box; cursor: pointer; text-decoration: none; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-transform: capitalize; border-color: #1231ef;'> Sign In</a>
                        </p>
                      </td>
                    </tr>
                  </table>
