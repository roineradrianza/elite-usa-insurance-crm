                  ...
                  <table border='0' cellpadding='0' cellspacing='0' style='border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;'>
                    <tr>
                      <td style='font-size: 16px; vertical-align: top;'>
                        <p style="text-align: center">Information requested has been updated by <?php echo $agent ?>.</p>
                        <p>Information requested: <b><?php echo $information_requested ?></b></p>
                        <p>Information received: <b><?php echo $info ?></b></p>
