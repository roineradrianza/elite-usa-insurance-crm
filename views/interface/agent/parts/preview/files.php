<template v-if="quotes.editedItem.documents !== null">
    <template v-if="quotes.editedItem.affordable_care_act.hasOwnProperty('additional_notes') && quotes.editedItem.affordable_care_act.additional_notes != ''">
        <v-col cols="12">
            <h3 class="font-weight-bold primary--text">ADDITIONAL NOTES</h3>
        </v-col>
        <v-col cols="12">
            {{ quotes.editedItem.affordable_care_act.additional_notes }}
        </v-col>
    </template>
