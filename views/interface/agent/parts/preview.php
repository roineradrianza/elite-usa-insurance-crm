            ...
            <v-container fluid>
                <v-row ref="preview_quote" v-if="quotes.editedIndex != -1">
                    <v-col class="mb-4 mt-n10" cols="12" md="6" lg="4" offset-md="3" offset-lg="4"
                        v-if="quotes.editedItem.renewals.length > 0">
                            ...
                            <v-row align="center">
                                ...
                                <v-col class="shrink">
                                    <v-btn class="primary--text" color="white"
                                        @click="filterQuotes(quotes.editedItem.renewals[0].ID)">
                                        Take me to
                                    </v-btn>
                                </v-col>
                            </v-row>
                    ...
                    <v-col class="d-flex justify-end mt-n10" cols="10">
                        ...
                        <v-btn class="mr-3 py-4" color="info"
                            @click="action_history.dialog = true;getActionsHistory(quotes.editedItem)" small>View
                            Actions History</v-btn>
                        <v-btn class="mr-3 py-4" color="primary" @click="generateQuotePDF" :loading="pdf_loading" small>
                            Download Quote</v-btn>
