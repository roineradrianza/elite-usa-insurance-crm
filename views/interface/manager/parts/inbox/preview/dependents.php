<template v-if="inbox.editedItem.dependents.length > 0 && inbox.editedItem.affordable_care_act.coverage_type == 'FAMILY'">
  <v-col cols="12">
    <h3 class="font-weight-bold primary--text">DEPENDENTS</h3>
  </v-col>

  <template v-for="(dependent, index) in inbox.editedItem.dependents">
    <v-col cols="12">
    ...
    <v-col cols="12" md="6">
      <p class="font-weight-bold">USCIS NUMBER: <span class="font-weight-light">{{ dependent.uscis_number }}</span></p>
    </v-col>
    <v-col cols="12" md="6">
