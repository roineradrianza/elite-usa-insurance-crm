<template>
  ...
  <v-col cols="12" md="6" lg="4">
    <p class="font-weight-bold">COMPANY: <span class="font-weight-light">{{ inbox.editedItem.affordable_care_act.company_plan }}</span></p>
  </v-col>
  <v-col cols="12" md="6" lg="4">
    <p class="font-weight-bold">PLAN: <span class="font-weight-light">{{ inbox.editedItem.affordable_care_act.plan }}</span></p>
  </v-col>
  <v-col cols="12" md="6" lg="4">
