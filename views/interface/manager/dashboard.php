      ...
      <v-container class="mb-n2" id="app-container" fluid>
        <v-row>
          ...
          <v-col cols="10">
            ...
            <v-row>
              <v-col cols="12">
                <v-data-table :headers="quotes.header" :items="quotes.items" sort-by="['status','published_at']" :search="quotes.search" class="elevation-1" :loading="table_loading" multi-sort>
                  <template #top>
