      ...
      <v-container class="mb-n2" id="app-container" fluid>
        <v-row>
          ...
          <v-col cols="10">
            ...
            <?php echo RA_ELITE_USA_INSURANCE_TEMPLATE::show_template('components/snackbar') ?>
            <?php echo RA_ELITE_USA_INSURANCE_TEMPLATE::show_template('interface/superuser/user-manager/preview') ?>
            <?php echo RA_ELITE_USA_INSURANCE_TEMPLATE::show_template('interface/superuser/user-manager/edit') ?>
            <?php echo RA_ELITE_USA_INSURANCE_TEMPLATE::show_template('interface/superuser/user-manager/delete') ?>
