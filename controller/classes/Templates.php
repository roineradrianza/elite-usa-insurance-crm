...
class RA_ELITE_USA_INSURANCE_TEMPLATE
{
	...
	public static function load_template($template_name, $ra_elite_usa_insurance_vars = array())
	{
		ob_start();
	...
	public static function show_template($template_name, $ra_elite_usa_insurance_vars = array())
	{
		echo self::load_template($template_name, $ra_elite_usa_insurance_vars);
	}
	public static function locate_template($template_name, $ra_elite_usa_insurance_vars = array())
	{
	 ...
	 public static function render_view($styles = array(),$scripts = array(), $template = '', $vars = []) {
