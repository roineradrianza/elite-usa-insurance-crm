## V1.5.0
1. FEATURES
   - SUPPORT SIDEBAR SUBMENUS
   - REPORTS:
      * RENEWALS AND NEW QUOTES
2. OPTIMIZATION
   - USER CLASS REFACTORED
   - GET SESSION METHOD ADDED TO USER CLASS
   - DASHBOARD SHORTCODE CLASS REFACTORED
3. BUG FIXES
   - DATE TIME FORMAT INCOMPATIBILITY ON FIREFOX
   - FIX ASSETS LOADING ON ADMIN SETTINGS
